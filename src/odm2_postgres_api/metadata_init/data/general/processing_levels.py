...
processing_levels = [
    ...
    },
    {
        ...
        "explanation": "Automated procedures have been applied as "
        "an initial quality control. These procedures leave the "
        "data as is but flag obviously erroneous values using a qualitycode",
    },
    {
        "processinglevelcode": "0.1",
        "definition": "First Pass QC",
        "explanation": "A first quality control pass has been performed "
        "to remove out of range and obviously erroneous "
    ...
    },
    {
        ...
        "explanation": "Quality controlled data have passed quality "
