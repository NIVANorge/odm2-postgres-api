...
def mass_spec_variables() -> List[VariablesCreate]:
    mass_spec_variables_list = [{
        ...
        "LC_QTOF_Raw",
        "variabledefinition":
        "Raw data produced by Liquid Chromatography coupled to Quadrupole Time of Flight "
        "instrument",
        "variablecode":
        f'mass_spec_00',
        "nodatavalue":
        ...
        "LC_QTOF_mzXML",
        "variabledefinition":
        "Data produced by Liquid Chromatography coupled to Quadrupole Time of Flight "
        "instrument and converted to mzXML format",
        "variablecode":
        f'mass_spec_01',
        "nodatavalue":
        ...
        "LC_QTOF_Peaks",
        "variabledefinition":
        "Peaks detected by Liquid Chromatography coupled to Quadrupole Time of Flight "
        "instrument",
        "variablecode":
        f'mass_spec_1',
        "nodatavalue":
        ...
        "Chemistry",
        "variablenamecv":
        "LC_QTOF_Peaks_and_Fragments",
        "variabledefinition":
        "Peaks and fragments detected by Liquid Chromatography coupled to Quadrupole "
        ...
        "LC_QTOF_Chemicals",
        "variabledefinition":
        "Peaks identified in Liquid Chromatography coupled to Quadrupole Time of Flight "
        "instrument",
        "variablecode":
        f'mass_spec_3',
        "nodatavalue":
...
def mass_spec_methods(org_id: int) -> List[MethodsCreate]:
    methods = [{
        ...
        "Derivation",
        "methodcode":
        "mass_spec:ms_convert_filter_scanEvent_1_2",
        "methodname":
        "ms convert",
        "methoddescription":
        "",
        ...
        "annotations": [{
            ...
            "Method annotation",
            "annotationtext":
            "The json field holds the parameters with which this method will be executed",
            "annotationjson":
            json.dumps({
                "verbose": '-v',
                "bits": '--32',
        ...
        "Derivation",
        "methodcode":
        "mass_spec:fd_nointerp_nscan40_allmz",
        "methodname":
        "feature detection",
        "methoddescription":
        "Detects features in raw data.  Parameters are "
        ...
        "Derivation",
        "methodcode":
        "mass_spec:fd_nointerp_nscan40_allmz_test",
        "methodname":
        "feature detection",
        "methoddescription":
        "Detects features in raw data. This is a test version of method "
        ...
        "Derivation",
        "methodcode":
        "mass_spec:fid_positive_16032020",
        "methodname":
        "feature identification",
        "methoddescription":
        "Identifies features previously detected using a fd_* and fdc methods. "
        ...
        "Derivation",
        "methodcode":
        "mass_spec:fid_negative_16032020",
        "methodname":
        "feature identification",
        "methoddescription":
        "Identifies features previously detected using a fd_* and fdc methods. "
        ...
        "methoddescription":
        "Find fragments for peaks detected with fd_* method."
