...
def create_new_fantasy_track_result(new_track_result: dict):
    if "derived_from" in new_track_result:
        action_response = post_to_odm2_api(
            "actions",
            {
                ...
                # methodcode = 001: "A method from NIVA for deriving a result from another result"
                "methodcode": "001",
    ...
    result_response = post_to_odm2_api(
        "results",
        {
            ...
            # processinglevelid = 2: "processinglevelcode": "0.05", "definition": "Automated QC"
            "processinglevelid": 2,
            "valuecount": 0,
            "statuscv": "Ongoing",
            "sampledmediumcv": "Liquid aqueous",
    ...
    track_result_response = post_to_odm2_api(
        "track_results",
        {
