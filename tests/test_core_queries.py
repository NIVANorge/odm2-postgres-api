...
BEGROING_TAXON_ROWS = [
    {
        "Artsliste_Begroing_Sys_Id": 1,
        "rubin_kode": "AC AU;HE",
        "latinsk_navn": "Achnanthes austriaca var. helvetica",
        "autor": "Hust.",
        "autor_ref": None,
        "synonym": "ACHN HEL",
        "takson_type": "VARIET",
        "eier_takson": "BACILLAR",
        "ph_opt": 5.4,
        "ph_ref": "Stevenson",
        "Kommentar": None,
        "Reg_Dato": None,
        "Reg_Av": None,
        "Mod_Dato": "2016-02-04 15:56:28",
        "Mod_Av": None,
        "FF-verdi": None,
        "rubin_nr": None,
        "merke": None,
    ...
    {
        "Artsliste_Begroing_Sys_Id": 2,
        "rubin_kode": "AC CL;RO",
        "latinsk_navn": "Achnanthes clevi var. rostrata",
        "autor": "Hust.",
        "autor_ref": None,
        "synonym": None,
        "takson_type": "VARIET",
    ...
    {
        "Artsliste_Begroing_Sys_Id": 3,
        "rubin_kode": "AC LA;EL",
        "latinsk_navn": "Achnanthes lanceolata var. eliptica",
        "autor": "Cleve",
        "autor_ref": None,
        "synonym": None,
        "takson_type": "VARIET",
    ...
    {
        "Artsliste_Begroing_Sys_Id": 4,
        "rubin_kode": "AC LI;PU",
        "latinsk_navn": "Achnanthes linearis var. pusilla",
        "autor": "Grun.",
        "autor_ref": None,
        "synonym": "ACHN LIN",
        "takson_type": "VARIET",
    ...
    {
        "Artsliste_Begroing_Sys_Id": 5,
        "rubin_kode": "AC MI;CR",
        "latinsk_navn": "Achnanthes minutissima var. cryptocephala",
        "autor": "Grun.",
        "autor_ref": None,
        "synonym": "ACHN MIN",
        "takson_type": "VARIET",
...
def format_taxon_data(row, related_taxonomic_classifiers=None):
    ...
    data = {
        ...
        "taxonomicclassifierdescription": "Taken from begroing access database, " "check annotation for original row",
